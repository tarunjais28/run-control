...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) -> () {
        ...
        info!(logger, "con_str: {}", self.con_str());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let con_str = matches
            .value_of("con_str")
            .expect("Error getting `con_str` value.")
            .to_string();
...
fn get_args_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .about("Orchestrator Appliation MS SQL!")
        .arg(
        ...
        .arg(
            Arg::with_name("con_str")
                .short("c")
                .long("con-str")
                .value_name("Conection String")
                .help("Contains Conection String for MS SQL Server conectivity.")
                .required(true)
        )
        .arg(
